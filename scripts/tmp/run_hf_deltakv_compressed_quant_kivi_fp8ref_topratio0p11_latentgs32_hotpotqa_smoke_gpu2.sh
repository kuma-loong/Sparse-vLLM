...
CONFIG_PATH="configs/qwen2_5_7b_hf_deltakv_compressed_quant_kivi4_fp8ref_topratio0p11_latentgs32_paper_full_layers_center0p1_stride0p001.json"
...
RUN_ID="${RUN_ID:-hf_compressed_quant_kivi_fp8ref_topratio0p11_latentgs32_hotpotqa_smoke_gpu2_$(date +%Y%m%d_%H%M%S)}"
...

{
  ...
  conda run -n svllm python -u benchmark/long_bench/pred.py \
    --model qwen25-7b-hf-deltakv-cq-kivi4-fp8ref-topratio0p11-latentgs32-smoke \
