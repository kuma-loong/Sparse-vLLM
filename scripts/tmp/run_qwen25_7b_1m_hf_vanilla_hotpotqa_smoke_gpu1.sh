...
CONFIG_PATH="configs/qwen2_5_7b_1m_hf_vanilla_chunk32768.json"
MODEL_PATH="/data2/haojitai/models/Qwen2.5-7B-Instruct-1M"
RUN_ID="${RUN_ID:-qwen25_7b_1m_hf_vanilla_hotpotqa_smoke_gpu1_$(date +%Y%m%d_%H%M%S)}"
...

{
  ...
  conda run -n svllm python -u benchmark/long_bench/pred.py \
    --model qwen25-7b-1m-hf-vanilla-smoke \
