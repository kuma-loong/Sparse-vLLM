...
RUN_ID="hotpotqa_kv_quant_error_stride0_center0p2_gs32_exclude_tail32_20samples_gpu5_20260601_220130"
...
conda run -n svllm python -u src/deltakv/analysis/analyze_hotpotqa_kv_quant_error.py \
  ...
  --analysis_mode both \
  --deltakv_quant_group_size_override 32 \
  --exclude_tail_tokens_from_stats 32 \
  --kivi_bits 2 \
  --kivi_group_size 32 \
