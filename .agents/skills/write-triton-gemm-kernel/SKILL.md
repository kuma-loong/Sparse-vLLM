---
name: write-triton-gemm-kernel
description: Implement correct, performant blocked GEMM and fused-epilogue kernels in Triton with tiling, masking, and autotuning.
---
