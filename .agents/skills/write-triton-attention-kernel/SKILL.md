---
name: write-triton-attention-kernel
description: Implement fused Flash Attention 2-style and custom attention kernels in Triton with stable online softmax and correct masking.
---
