---
name: write-triton-softmax-kernel
description: Implement numerically stable row-wise and masked softmax kernels in Triton with correct reduction sizing and boundary handling.
---
