...
- `svllm-benchmark`: Run Sparse-vLLM benchmark plans, maintain benchmark ledgers, choose reliable repo-local benchmarks, and interpret speed/quality/cache metrics. File: `.agents/skills/svllm-benchmark/SKILL.md`

## How to use

- In this repo, invoke the sparse-method skill as `$add-sparse-method`.
- In this repo, invoke the benchmark skill as `$svllm-benchmark`.
